...
use Tinywan\RedisStream\Adapter\WebmanAdapter;
...
class QueueService
{
    ...
    {
        $producer = WebmanAdapter::createProducer('task');
    ...
    {
        $consumer = WebmanAdapter::createConsumer('task');
    ...
    {
        $consumer = WebmanAdapter::createConsumer('default');
